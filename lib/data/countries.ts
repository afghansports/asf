/**
 * 195 countries (per ASF_LAUNCH_PRD.md > SEED DATA #2).
 * Source of truth for CountryPicker and PhoneInput country code dropdown.
 *
 * Per Design System: flag emojis ARE permitted in CountryPicker (the only
 * exception to the "no emoji icons" rule, since flag visuals are part of
 * country identification).
 *
 * Fields:
 *  - code: ISO 3166-1 alpha-2
 *  - name: English short name
 *  - flag: Unicode regional-indicator emoji
 *  - dial: country dialing code (E.164, no leading +)
 */
